...
public abstract class FPSPlayerControllerBase : FPSDamageableController {
    ...
    [Inject] public CollectionMagazineController CollectionMagazineController {get;set;}
...
public abstract class CollectionMagazineControllerBase : Controller {
    ...
    public override ViewModel CreateEmpty() {
        return new CollectionMagazineViewModel(this);
    }
    
    public virtual CollectionMagazineViewModel CreateCollectionMagazine() {
        return ((CollectionMagazineViewModel)(this.Create()));
    }
    
    public override void Initialize(ViewModel viewModel) {
        this.InitializeCollectionMagazine(((CollectionMagazineViewModel)(viewModel)));
    }
