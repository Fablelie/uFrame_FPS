...
public class FPSPlayerViewModelBase : FPSDamageableViewModel {
    ...
    public P<Int32> _CollectedMagProperty;
    
    public P<FPSWeaponViewModel> _ParentWeaponProperty;
    
    public P<CollectionMagazineViewModel> _ParentMagProperty;
    
    public P<Boolean> _FirstTimeProperty;
    
    public P<FPSWeaponViewModel> _CurrentWeaponProperty;
    
    public ModelCollection<FPSWeaponViewModel> _WeaponsProperty;
    
    public ModelCollection<CollectionMagazineViewModel> _MagazineProperty;
    ...
    protected CommandWithSenderAndArgument<FPSPlayerViewModel, CollectionMagazineViewModel> _PickupMagazine;
    ...
    public override void Bind() {
        ...
        _CollectedMagProperty = new P<Int32>(this, "CollectedMag");
        _ParentWeaponProperty = new P<FPSWeaponViewModel>(this, "ParentWeapon");
        _ParentMagProperty = new P<CollectionMagazineViewModel>(this, "ParentMag");
        _FirstTimeProperty = new P<Boolean>(this, "FirstTime");
        ...
        _MagazineProperty = new ModelCollection<CollectionMagazineViewModel>(this, "Magazine");
        _MagazineProperty.CollectionChanged += MagazineCollectionChanged;
    ...
    protected virtual void MagazineCollectionChanged(System.Collections.Specialized.NotifyCollectionChangedEventArgs args) {
    }
...
public partial class FPSPlayerViewModel : FPSPlayerViewModelBase {
    ...
    public virtual P<Int32> CollectedMagProperty {
        get {
            return this._CollectedMagProperty;
        }
    }
    
    public virtual Int32 CollectedMag {
        get {
            return _CollectedMagProperty.Value;
        }
        set {
            _CollectedMagProperty.Value = value;
        }
    }
    
    public virtual P<FPSWeaponViewModel> ParentWeaponProperty {
        get {
            return this._ParentWeaponProperty;
        }
    }
    
    public virtual FPSWeaponViewModel ParentWeapon {
        get {
            return _ParentWeaponProperty.Value;
        }
        set {
            _ParentWeaponProperty.Value = value;
            if (value != null) value.ParentFPSPlayer = this;
        }
    }
    
    public virtual P<CollectionMagazineViewModel> ParentMagProperty {
        get {
            return this._ParentMagProperty;
        }
    }
    
    public virtual CollectionMagazineViewModel ParentMag {
        get {
            return _ParentMagProperty.Value;
        }
        set {
            _ParentMagProperty.Value = value;
            if (value != null) value.ParentFPSPlayer = this;
        }
    }
    
    public virtual P<Boolean> FirstTimeProperty {
        get {
            return this._FirstTimeProperty;
        }
    }
    
    public virtual Boolean FirstTime {
        get {
            return _FirstTimeProperty.Value;
        }
        set {
            _FirstTimeProperty.Value = value;
        }
    }
    ...
    public virtual ModelCollection<CollectionMagazineViewModel> Magazine {
        get {
            return this._MagazineProperty;
        }
    }
    ...
    public virtual CommandWithSenderAndArgument<FPSPlayerViewModel, CollectionMagazineViewModel> PickupMagazine {
        get {
            return _PickupMagazine;
        }
        set {
            _PickupMagazine = value;
        }
    }
    ...
    protected override void WireCommands(Controller controller) {
        ...
        this.PickupMagazine = new CommandWithSenderAndArgument<FPSPlayerViewModel, CollectionMagazineViewModel>(this, fPSPlayer.PickupMagazine);
    }
    
    public override void Write(ISerializerStream stream) {
		base.Write(stream);
        stream.SerializeInt("CurrentWeaponIndex", this.CurrentWeaponIndex);
        stream.SerializeInt("CollectedMag", this.CollectedMag);
		if (stream.DeepSerialize) stream.SerializeObject("ParentWeapon", this.ParentWeapon);
		if (stream.DeepSerialize) stream.SerializeObject("ParentMag", this.ParentMag);
        stream.SerializeBool("FirstTime", this.FirstTime);
        if (stream.DeepSerialize) stream.SerializeArray("Weapons", this.Weapons);
        if (stream.DeepSerialize) stream.SerializeArray("Magazine", this.Magazine);
    }
    
    public override void Read(ISerializerStream stream) {
		base.Read(stream);
        		this.CurrentWeaponIndex = stream.DeserializeInt("CurrentWeaponIndex");;
        		this.CollectedMag = stream.DeserializeInt("CollectedMag");;
		if (stream.DeepSerialize) this.ParentWeapon = stream.DeserializeObject<FPSWeaponViewModel>("ParentWeapon");
		if (stream.DeepSerialize) this.ParentMag = stream.DeserializeObject<CollectionMagazineViewModel>("ParentMag");
        		this.FirstTime = stream.DeserializeBool("FirstTime");;
if (stream.DeepSerialize) {
        this.Weapons.Clear();
...
if (stream.DeepSerialize) {
        this.Magazine.Clear();
        this.Magazine.AddRange(stream.DeserializeObjectArray<CollectionMagazineViewModel>("Magazine"));
}
    }
    ...
    protected override void FillProperties(List<ViewModelPropertyInfo> list) {
        ...
        list.Add(new ViewModelPropertyInfo(_CollectedMagProperty, false, false, false));
        list.Add(new ViewModelPropertyInfo(_ParentWeaponProperty, true, false, false));
        list.Add(new ViewModelPropertyInfo(_ParentMagProperty, true, false, false));
        list.Add(new ViewModelPropertyInfo(_FirstTimeProperty, false, false, false));
        ...
        list.Add(new ViewModelPropertyInfo(_MagazineProperty, true, true, false));
    }
    ...
    protected override void FillCommands(List<ViewModelCommandInfo> list) {
        ...
        list.Add(new ViewModelCommandInfo("PickupMagazine", PickupMagazine) { ParameterType = typeof(CollectionMagazineViewModel) });
    }
    ...
    protected override void MagazineCollectionChanged(System.Collections.Specialized.NotifyCollectionChangedEventArgs args) {
        foreach (var item in args.NewItems.OfType<CollectionMagazineViewModel>()) item.ParentFPSPlayer = this;;
    }
}
...
public class FPSWeaponViewModelBase : ViewModel {
    ...
    public P<Int32> _DamageProperty;
    
    public P<Int32> _CollectionMagProperty;
    ...
    protected CommandWithSender<FPSWeaponViewModel> _AddMagazine;
    ...
    public override void Bind() {
        ...
        _DamageProperty = new P<Int32>(this, "Damage");
        _CollectionMagProperty = new P<Int32>(this, "CollectionMag");
...
public partial class FPSWeaponViewModel : FPSWeaponViewModelBase {
    ...
    public virtual P<Int32> DamageProperty {
        get {
    ...
    public virtual P<Int32> CollectionMagProperty {
        get {
            return this._CollectionMagProperty;
        }
    }
    
    public virtual Int32 CollectionMag {
        get {
            return _CollectionMagProperty.Value;
        }
        set {
            _CollectionMagProperty.Value = value;
        }
    }
    ...
    public virtual CommandWithSender<FPSWeaponViewModel> AddMagazine {
        get {
            return _AddMagazine;
        }
        set {
    ...
    protected override void WireCommands(Controller controller) {
        ...
        this.AddMagazine = new CommandWithSender<FPSWeaponViewModel>(this, fPSWeapon.AddMagazine);
    }
    ...
    public override void Write(ISerializerStream stream) {
        ...
        stream.SerializeInt("Damage", this.Damage);
        stream.SerializeInt("CollectionMag", this.CollectionMag);
    }
    ...
    public override void Read(ISerializerStream stream) {
        ...
        this._StateProperty.SetState(stream.DeserializeString("State"));
        		...
        		this.Damage = stream.DeserializeInt("Damage");;
        		this.CollectionMag = stream.DeserializeInt("CollectionMag");;
    }
    ...
    protected override void FillProperties(List<ViewModelPropertyInfo> list) {
        ...
        list.Add(new ViewModelPropertyInfo(_DamageProperty, false, false, false));
        list.Add(new ViewModelPropertyInfo(_CollectionMagProperty, false, false, false));
    ...
    protected override void FillCommands(List<ViewModelCommandInfo> list) {
        ...
        list.Add(new ViewModelCommandInfo("AddMagazine", AddMagazine) { ParameterType = typeof(void) });
    }
}
...
[DiagramInfoAttribute("FPSShooterProject")]
public class CollectionMagazineViewModelBase : ViewModel {
    
    public P<Int32> _AmountProperty;
    
    public P<Int32> _RoundSizeProperty;
    
    public P<CollectionMagazineType> _MagazineTypeProperty;
    
    protected CommandWithSender<CollectionMagazineViewModel> _AddMag;
    
    public CollectionMagazineViewModelBase(CollectionMagazineControllerBase controller, bool initialize = true) : 
            base(controller, initialize) {
    }
    
    public CollectionMagazineViewModelBase() : 
            base() {
    }
    ...
    public override void Bind() {
        ...
        _RoundSizeProperty = new P<Int32>(this, "RoundSize");
        _MagazineTypeProperty = new P<CollectionMagazineType>(this, "MagazineType");
    }
}

public partial class CollectionMagazineViewModel : CollectionMagazineViewModelBase {
    
    private FPSPlayerViewModel _ParentFPSPlayer;
    
    public CollectionMagazineViewModel(CollectionMagazineControllerBase controller, bool initialize = true) : 
            base(controller, initialize) {
    }
    
    public CollectionMagazineViewModel() : 
            base() {
    }
    ...
    public virtual P<CollectionMagazineType> MagazineTypeProperty {
        get {
            return this._MagazineTypeProperty;
        }
    }
    
    public virtual CollectionMagazineType MagazineType {
        get {
            return _MagazineTypeProperty.Value;
        }
        set {
            _MagazineTypeProperty.Value = value;
        }
    }
    
    public virtual CommandWithSender<CollectionMagazineViewModel> AddMag {
        get {
            return _AddMag;
        }
        set {
    ...
    protected override void WireCommands(Controller controller) {
        var collectionMagazine = controller as CollectionMagazineControllerBase;
        this.AddMag = new CommandWithSender<CollectionMagazineViewModel>(this, collectionMagazine.AddMag);
    }
    ...
    public override void Write(ISerializerStream stream) {
        ...
        stream.SerializeInt("RoundSize", this.RoundSize);
		stream.SerializeInt("MagazineType", (int)this.MagazineType);
    }
    ...
    public override void Read(ISerializerStream stream) {
		base.Read(stream);
        		...
        		this.RoundSize = stream.DeserializeInt("RoundSize");;
		this.MagazineType = (CollectionMagazineType)stream.DeserializeInt("MagazineType");
    }
    ...
    protected override void FillProperties(List<ViewModelPropertyInfo> list) {
        ...
        list.Add(new ViewModelPropertyInfo(_RoundSizeProperty, false, false, false));
        list.Add(new ViewModelPropertyInfo(_MagazineTypeProperty, false, false, true));
    }
    
    protected override void FillCommands(List<ViewModelCommandInfo> list) {
        base.FillCommands(list);;
        list.Add(new ViewModelCommandInfo("AddMag", AddMag) { ParameterType = typeof(void) });
    }
}
...
public enum CollectionMagazineType {
