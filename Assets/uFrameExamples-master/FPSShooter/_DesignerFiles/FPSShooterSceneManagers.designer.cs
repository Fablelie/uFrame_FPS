...
public class WavesFPSGameManagerBase : SceneManager {
    ...
    private CollectionMagazineController _CollectionMagazineController;
    ...
    [Inject()]
    public virtual CollectionMagazineController CollectionMagazineController {
        get {
            if ((this._CollectionMagazineController == null)) {
                this._CollectionMagazineController = new CollectionMagazineController() { Container = Container };
            }
            return this._CollectionMagazineController;
        }
        set {
            _CollectionMagazineController = value;
        }
    }
    ...
    public override void Setup() {
        ...
        Container.RegisterController<CollectionMagazineController>(CollectionMagazineController);
        this.Container.InjectAll();
